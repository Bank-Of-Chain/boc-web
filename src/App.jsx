...
function App() {
  ...
  useEffect(() => {
    ...
    if (
      (isEmpty(localStorage.REACT_APP_NETWORK_TYPE) && selectedChainId > 0) ||
      `${selectedChainId}` !== localStorage.REACT_APP_NETWORK_TYPE
    ) {
  ...
  const renderModalValid = () => {
    ...
    if (
      ...
      return modalJsx(true, [
        ...
        <Chains
          key="3"
          maskStyle={{ textAlign: "center", marginTop: 24 }}
          array={NET_WORKS}
          handleClick={changeNetwork}
        />,
      ]);
