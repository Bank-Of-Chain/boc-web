...
const Loading = props => {
  const { loading, children = '', width = '20px', height = '20px', background } = props
  const loadingElement = (
    <svg style={{ background: background }} width={width} height={height} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
