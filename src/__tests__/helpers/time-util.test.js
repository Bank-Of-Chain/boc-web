...
test('getLastAllocationTime return correct time', () => {
  ...
  const nextAllocationTime = moment().startOf('week').subtract(-8, 'day').set('hour', 7).set('minute', 0).set('second', 0).set('millisecond', 0)
...
test('getLastDohardworkTime return correct time', () => {
  ...
  const nextDohardworkTime = moment().subtract(-1, 'day').set('hour', 7).set('minute', 0).set('second', 0).set('millisecond', 0)
