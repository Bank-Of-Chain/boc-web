...
const RiskOn = props => {
  ...
  console.log('CREDIT_POOL_ADDRESS=', CREDIT_POOL_ADDRESS)
  ...
  // if not connect to instance, we must connect firstly!
...
export default useVersionWapper(RiskOn, 'lever')
